...
public class ViandaDao {
	...
	public int agregar(Vianda objeto) {
		int id = 0;
		try {
			iniciaOperacion();
	...
	public void actualizar(Vianda objeto) throws HibernateException {
		try {
			iniciaOperacion();
	...
	public void eliminar(Vianda objeto) throws HibernateException {
		try {
			iniciaOperacion();
