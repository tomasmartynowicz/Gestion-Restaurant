...
public class UsuarioABM {
	...
	public Usuario iniciarSesion(String usuario, String pass){
		...
		if(u != null){
			if(!u.getClave().equals(pass)) u = null;
		}
		return u;
	}
	...
	public Usuario altaDeUsuario(Empleado empleado, String nombreUsuario, String clave, Categoria categoria)throws Exception{
		...
		if(u == null){ //el empleado no tiene usuario
			if(u2 != null) throw new Exception("El nombre de usuario ya est� en uso");
			...
			if((u2 != null) && (u2.getEmpleado().getIdEmpleado() != empleado.getIdEmpleado())) throw new Exception("El nombre de usuario ya est� en uso");
