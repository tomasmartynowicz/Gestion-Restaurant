	...
	private void procesarPeticion(HttpServletRequest request, HttpServletResponse response) 
			 throws ServletException, IOException {
				...
				try{
					...
					response.sendError(500, "Error en el controlador de Eliminar Comanda" + e.getMessage());
				}
				request.getRequestDispatcher("/eliminarcomanda.jsp").forward(request, response);
	} 
}