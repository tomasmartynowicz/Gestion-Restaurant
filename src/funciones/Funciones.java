...
public class Funciones {
	...
	public static GregorianCalendar traerFechaMesProximo(GregorianCalendar fecha, int cantMeses){
		
		GregorianCalendar fechaProxima = traerFecha(traerAnio(fecha), traerMes(fecha), traerDia(fecha));
		fechaProxima.add(Calendar.MONTH, cantMeses);
		return fechaProxima;
	}
	...
	public static GregorianCalendar traerSiguienteDiaHabil(GregorianCalendar fecha){
		GregorianCalendar fechaProxima =  traerFecha(traerAnio(fecha), traerMes(fecha), traerDia(fecha));;
		
		do {
			fechaProxima.add(Calendar.DAY_OF_MONTH, 1);
		} while(!esDiaHabil(fechaProxima));
	...
	public static int traerCantDias(GregorianCalendar fechaInicio
									, GregorianCalendar fechaFin) {
		int cantDias=0;
		
		while(!Funciones.sonFechasIguales(fechaInicio, fechaFin)){
